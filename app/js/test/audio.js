...
var soundNotAllowed = (error) => {
  h.innerHTML = "Nie wykryto mikrofonu";
  console.log(error);
};
...
document.getElementById("button").onclick = function () {
  if (start) {
    start = false;
    this.innerHTML = "<span class='fa fa-play'></span>Stereo test";
    this.className = "green-button";
    document.getElementById("stereoTest").pause();
  } else {
    start = true;
    this.innerHTML = "<span class='fa fa-stop'></span>Zatrzymaj";
    this.className = "red-button";
    document.getElementById("stereoTest").play();
  }
};
