...
$(document).ready(function () {
  ...
  $(document).on("keyup press", function (event) {
    event.keyCode !== 27 && event.preventDefault();
    var key = event.keyCode;
...
const kbtButton = document.getElementById("keyboardTestButton");
const kbt = document.getElementById("keyboardTest");

kbtButton.onclick = () => {
  if (kbtButton.className === "red-button") {
    kbtButton.className = "green-button";
    kbt.style.display = "none";
    document
      .querySelectorAll(".active")
      .forEach((item) => item.classList.remove("active"));
  } else {
    kbtButton.className = "red-button";
